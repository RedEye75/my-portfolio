...
const Contact = () => {
  return (
    <div className="mt-10 min-h-screen">
      <section class="relative z-10 text-white overflow-hidden bg-[#2a2a2a] py-20 lg:py-[120px]">
        <div class="container mx-auto">
          <div class="-mx-4 flex flex-wrap lg:justify-between">
              ...
              <div class="mb-12 max-w-[570px] lg:mb-0">
                ...
                <div class="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div class="w-full">
                    ...
                    <p class="text-body-color text-base">+880 1318-330734</p>
                  </div>
                </div>
                <div class="mb-8 flex w-full max-w-[370px]">
                  <div class="bg-primary text-primary mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[70px] sm:max-w-[70px]">
            ...
            <div class="w-full px-4 lg:w-1/2 xl:w-5/12">
              <div class="relative rounded-lg bg-gray-*00 p-8 shadow-lg sm:p-12">
                <form>
                  <div class="mb-6">
                    <input
                      type="text"
